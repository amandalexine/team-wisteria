...
import numpy as np
import pygame
from testSeq import set_computer_volume # imported from Jonah's code
import testSeq
import openpyxl
...
def save_input(name_entry, age_entry, contact_info_entry, label):
    ...
    name = name_entry.get().lower() if name_entry is not None else ""
    age = age_entry.get() if age_entry is not None else ""
    contact_info = contact_info_entry.get() if contact_info_entry is not None else ""

    print("DEBUG name_entry:", name_entry)
    print("DEBUG age_entry:", age_entry)
    print("DEBUG contact_info_entry:", contact_info_entry)

...
def save_stats_results_to_excel(excel_file, stats_data):
    ...
    Args:
        excel_file (str): Path to Excel file.
        stats_data (dict): Dictionary structured as:
                           { signal_type: {
                               'baseline': {...},
                               'test': {...},
                               'diff': {...},
    ...
    for signal_type, categories in stats_data.items():
        ...
        if categories['baseline'] is not None:
            ...
            for stat in stat_types: 
                ...
                # get values for baseline, test signals and the percent difference, as well as the flag

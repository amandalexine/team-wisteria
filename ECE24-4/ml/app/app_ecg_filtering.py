# ecg_filtering.py
# Author: Anna Lee & Karen Bei / Karen Bei
...
def run_ecg_filtering(file_path, sheets=['Baseline Data', 'Test Data']):
    #read excel sheet
    ...
    return filtered_outputs['Test Data']['ECG'].values.reshape(-1, 1), fs

def save_filtered(filtered_outputs):
...
if __name__ == "__main__":
    ...
    outputs, fs = run_ecg_filtering(file_path)
    save_filtered(outputs)
    plt.show()

...
class error_stats:
    ...
    def plot_sectioned_stats(stats_result,title):
        ...
        plt.title('Maximum Values per Section')
        plt.xlabel('Section')
        plt.ylabel('Max Value')

        plt.subplot(2, 2, 2)
        plt.plot(section_numbers, min_values, marker='o')
        plt.title('Minimum Values per Section')
        plt.xlabel('Section')
        plt.ylabel('Min Value')

        plt.subplot(2, 2, 3)
        plt.plot(section_numbers, mean_values, marker='o')
        plt.title('Mean Values per Section')
        plt.xlabel('Section')
        plt.ylabel('Mean Value')

        plt.subplot(2, 2, 4)
        plt.plot(section_numbers, std_dev_values, marker='o')
        plt.title('Standard Deviation Values per Section')
        plt.xlabel('Section')
...
def import_matrix_from_txt(filename): #code for importing matrix into arrays
    ...
    for line in lines:
        ...
        channel_0_data.append(int(elements[0]))  #Skip the first value, index 0
        channel_1_data.append(int(elements[1]))
        channel_2_data.append(int(elements[2]))
